---
id: ray-observability.key-concepts
title: Key Concepts
topic_type: concept
description: ''
subjects:
...
- worker
references: []
canonical_path: /en/latest/ray-observability/key-concepts
source: https://github.com/ray-project/ray/blob/master/doc/source/ray-observability/key-concepts.rst
...
> **Note:** View the Driver logs in your terminal or Jupyter Notebooks if you run Ray Jobs by executing the Ray Driver on the Head node directly or connecting via Ray Client.
