---
id: ray-observability.user-guides.profiling
title: Profiling
topic_type: task
description: ''
subjects:
...
- worker
references:
- /en/latest/ray-observability/images/memory-profiling-dashboard-view.png
- /en/latest/ray-observability/images/nsight-profiler-folder.png
canonical_path: /en/latest/ray-observability/user-guides/profiling
source: https://github.com/ray-project/ray/blob/master/doc/source/ray-observability/user-guides/profiling.md
...
> **Warning:** If your dashboard is accessible over a network without authentication, enabling profiling exposes side-effecting endpoints to potential abuse. Enable token authentication when using profiling on an exposed dashboard.
