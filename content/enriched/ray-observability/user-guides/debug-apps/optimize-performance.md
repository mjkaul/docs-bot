---
id: ray-observability.user-guides.debug-apps.optimize-performance
...
- worker
references: []
canonical_path: /en/latest/ray-observability/user-guides/debug-apps/optimize-performance
source: https://github.com/ray-project/ray/blob/master/doc/source/ray-observability/user-guides/debug-apps/optimize-performance.rst
...
The Ray dashboard  lets you profile Ray worker processes by clicking on the "Stack Trace" or "CPU Flame Graph"
...
* Convert your PyTorch script to a Ray Train training script or a Ray Data batch inference script. (no change to your profiler-related code)
...
GPU profiling is critical for ML training and inference. Ray allows users to run Nsight System Profiler with Ray actors and tasks. See for details.
