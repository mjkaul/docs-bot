---
id: ray-observability.user-guides.debug-apps.debug-failures
...
- worker
references: []
canonical_path: /en/latest/ray-observability/user-guides/debug-apps/debug-failures
source: https://github.com/ray-project/ray/blob/master/doc/source/ray-observability/user-guides/debug-apps/debug-failures.rst
...
- **Unintended system failures**: This means the remote tasks and actors failed due to unexpected system failures such as processes crashing (for example, by out-of-memory error) or nodes failing.
  ...
  1. [Linux Out of Memory killer](https://www.kernel.org/doc/gorman/html/understand/understand016.html) or Ray Memory Monitor kills processes with high memory usages to avoid out-of-memory.
...
Many Python developers use a debugger to debug Python programs, and [Python pdb](https://docs.python.org/3/library/pdb.html)) is one of the popular choices.
