...
- task
references: []
canonical_path: /en/latest/serve/resource-allocation
source: https://github.com/ray-project/ray/blob/master/doc/source/serve/resource-allocation.md
...
> **Note:** Some other libraries may not respect `OMP_NUM_THREADS` and have their own way to configure parallelism.
