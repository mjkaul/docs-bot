---
id: serve.tutorials.stable-diffusion
...
- replica
references: []
canonical_path: /en/latest/serve/tutorials/stable-diffusion
source: https://github.com/ray-project/ray/blob/master/doc/source/serve/tutorials/stable-diffusion.md
