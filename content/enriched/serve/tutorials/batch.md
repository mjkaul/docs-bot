...
- task
references: []
canonical_path: /en/latest/serve/tutorials/batch
source: https://github.com/ray-project/ray/blob/master/doc/source/serve/tutorials/batch.md
...
> **Note:** This tutorial focuses on online serving with batching. For offline batch processing of large datasets, see [batch inference with Ray Data](batch_inference_home).
...
> **Note:** Ray Serve uses *opportunistic batching* by default - executing requests as 
