---
id: serve.tutorials.triton-server-integration
title: Triton Server Integration
topic_type: task
description: ''
subjects:
- serve
...
- worker
references: []
canonical_path: /en/latest/serve/tutorials/triton-server-integration
source: https://github.com/ray-project/ray/blob/master/doc/source/serve/tutorials/triton-server-integration.md
...
> **Note:** You can also use remote model repository, such as AWS S3, to store the model files. To use remote model repository, you need to set the `model_repository` variable to the remote model repository path.  For example `model_repository = s3://<bucket_name>/<model_repository_path>`.
