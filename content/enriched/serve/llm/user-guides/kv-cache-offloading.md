---
id: serve.llm.user-guides.kv-cache-offloading
...
- runtime-env
references: []
canonical_path: /en/latest/serve/llm/user-guides/kv-cache-offloading
source: https://github.com/ray-project/ray/blob/master/doc/source/serve/llm/user-guides/kv-cache-offloading.md
...
> **Note:** Ray Serve doesn't provide KV cache offloading out of the box, but it integrates with vLLM solutions. This guide demonstrates one such integration: LMCache.
