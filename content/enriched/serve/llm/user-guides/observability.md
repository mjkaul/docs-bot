---
id: serve.llm.user-guides.observability
...
- replica
references:
- /en/latest/serve/llm/images/serve_llm_dashboard.png
canonical_path: /en/latest/serve/llm/user-guides/observability
source: https://github.com/ray-project/ray/blob/master/doc/source/serve/llm/user-guides/observability.md
...
Ray enables LLM service-level logging by default, making these statistics available through Grafana and Prometheus. For more details on configuring Grafana and Prometheus, see collect-metrics.
...
To opt out from usage data collection, see Ray usage stats for how to disable it.

## See also

- collect-metrics - Ray metrics collection guide
