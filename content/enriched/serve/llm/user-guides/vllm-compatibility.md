---
id: serve.llm.user-guides.vllm-compatibility
...
- task
references: []
canonical_path: /en/latest/serve/llm/user-guides/vllm-compatibility
source: https://github.com/ray-project/ray/blob/master/doc/source/serve/llm/user-guides/vllm-compatibility.md
