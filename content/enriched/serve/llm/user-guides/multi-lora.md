---
id: serve.llm.user-guides.multi-lora
title: Multi-LoRA deployment
topic_type: task
description: ''
subjects:
- serve
...
- task
references: []
canonical_path: /en/latest/serve/llm/user-guides/multi-lora
source: https://github.com/ray-project/ray/blob/master/doc/source/serve/llm/user-guides/multi-lora.md
