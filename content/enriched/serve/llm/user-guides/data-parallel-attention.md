---
id: serve.llm.user-guides.data-parallel-attention
title: Data parallel attention
topic_type: task
description: ''
subjects:
- serve
...
- replica
references: []
canonical_path: /en/latest/serve/llm/user-guides/data-parallel-attention
source: https://github.com/ray-project/ray/blob/master/doc/source/serve/llm/user-guides/data-parallel-attention.md
...
For more details, see ../architecture/serving-patterns/data-parallel.
...
> **Note:** This example uses 4 GPUs total (2 for prefill, 2 for decode). Adjust the `data_parallel_size` values based on your available GPU resources.

> **Note:** For this example to work, you need to have NIXL installed. See the prefill-decode guide for prerequisites and installation instructions.

## See also

- ../architecture/serving-patterns/data-parallel - Data parallel attention architecture details
- prefill-decode - Prefill-decode disaggregation guide
- ../architecture/serving-patterns/index - Overview of serving patterns
- ../quick-start - Basic LLM deployment examples
