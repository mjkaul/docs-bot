---
id: serve.llm.user-guides.sglang
title: SGLang integration
topic_type: task
description: ''
subjects:
- serve
...
- worker
references: []
canonical_path: /en/latest/serve/llm/user-guides/sglang
source: https://github.com/ray-project/ray/blob/master/doc/source/serve/llm/user-guides/sglang.md
...
> **Note:** Community SGLang support is in early development. Track progress and provide feedback at [ray-project/ray#61114](https://github.com/ray-project/ray/issues/61114).
