---
id: serve.llm.architecture.overview
...
- worker
references: []
canonical_path: /en/latest/serve/llm/architecture/overview
source: https://github.com/ray-project/ray/blob/master/doc/source/serve/llm/architecture/overview.md
...
See: serving-patterns/data-parallel
...
See: serving-patterns/prefill-decode
...
- core - Technical implementation details and extension points
- serving-patterns/index - Detailed serving pattern documentation
- routing-policies - Request routing architecture and patterns
