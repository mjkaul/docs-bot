---
id: serve.production-guide.docker
...
- worker
references: []
canonical_path: /en/latest/serve/production-guide/docker
source: https://github.com/ray-project/ray/blob/master/doc/source/serve/production-guide/docker.md
