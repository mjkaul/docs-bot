---
id: serve.production-guide.handling-dependencies
...
- runtime-env
references: []
canonical_path: /en/latest/serve/production-guide/handling-dependencies
source: https://github.com/ray-project/ray/blob/master/doc/source/serve/production-guide/handling-dependencies.md
...
> **Tip:** Avoid dynamically installing packages that install from source: these can be slow and
