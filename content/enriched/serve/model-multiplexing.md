...
- serve-handle
references: []
canonical_path: /en/latest/serve/model-multiplexing
source: https://github.com/ray-project/ray/blob/master/doc/source/serve/model-multiplexing.md
