---
id: serve.asynchronous-inference
...
- worker
references: []
canonical_path: /en/latest/serve/asynchronous-inference
source: https://github.com/ray-project/ray/blob/master/doc/source/serve/asynchronous-inference.md
...
> **Note:** The filesystem broker is intended for local testing only and has limited functionality. For example, it doesn't support `cancel_tasks`. For production deployments, use a production-ready broker such as Redis or RabbitMQ. See the [Celery broker documentation](https://docs.celeryq.dev/en/stable/getting-started/backends-and-brokers/) for the full list of supported brokers.
