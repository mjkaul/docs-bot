---
id: serve.autoscaling-guide
title: Ray Serve Autoscaling
topic_type: task
description: ''
subjects:
- serve
...
canonical_path: /en/latest/serve/autoscaling-guide
source: https://github.com/ray-project/ray/blob/master/doc/source/serve/autoscaling-guide.md
...
> **Note:** When you set `num_replicas="auto"`, Ray Serve applies the defaults shown above,
