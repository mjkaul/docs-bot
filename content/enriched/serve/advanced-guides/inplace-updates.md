---
id: serve.advanced-guides.inplace-updates
title: Updating Applications In-Place
topic_type: task
description: ''
subjects:
- serve
...
- runtime-env
references: []
canonical_path: /en/latest/serve/advanced-guides/inplace-updates
source: https://github.com/ray-project/ray/blob/master/doc/source/serve/advanced-guides/inplace-updates.md
