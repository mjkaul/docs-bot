---
id: serve.advanced-guides.dyn-req-batch
...
- deployment
references: []
canonical_path: /en/latest/serve/advanced-guides/dyn-req-batch
source: https://github.com/ray-project/ray/blob/master/doc/source/serve/advanced-guides/dyn-req-batch.md
