---
id: serve.advanced-guides.gang-scheduling
...
- worker
references: []
canonical_path: /en/latest/serve/advanced-guides/gang-scheduling
source: https://github.com/ray-project/ray/blob/master/doc/source/serve/advanced-guides/gang-scheduling.md
license: Apache 2.0, The Ray Authors
---

# Gang scheduling

> **Note:** Gang scheduling is an **alpha** feature. The API may change in future releases.
...
> **Note:** Scale-to-zero (`min_replicas=0`) is not supported with gang scheduling.
...
> **Note:** `RESTART_REPLICA` (restarting only the failed replica while keeping healthy gang members running) is not yet supported. If you need this behavior, file a [GitHub issue](https://github.com/ray-project/ray/issues).
