---
id: serve.advanced-guides.managing-java-deployments
title: Experimental Java API
topic_type: task
description: ''
subjects:
- serve
...
- replica
references: []
canonical_path: /en/latest/serve/advanced-guides/managing-java-deployments
source: https://github.com/ray-project/ray/blob/master/doc/source/serve/advanced-guides/managing-java-deployments.md
...
> **Note:** Before `Ray.init` or `Serve.start`, you need to specify a directory to find the Python code. For details, please refer to [Cross-Language Programming](cross_language).
