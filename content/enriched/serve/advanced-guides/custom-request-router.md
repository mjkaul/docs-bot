---
id: serve.advanced-guides.custom-request-router
title: Use Custom Algorithm for Request Routing
topic_type: task
description: ''
subjects:
- serve
...
- serve-handle
references:
- /en/latest/serve/api/doc/ray.serve.config.DeploymentActorConfig
- /en/latest/serve/api/doc/ray.serve.config.RequestRouterConfig
- /en/latest/serve/api/doc/ray.serve.deployment_decorator
- /en/latest/serve/api/doc/ray.serve.request_router.FIFOMixin
- /en/latest/serve/api/doc/ray.serve.request_router.LocalityMixin
- /en/latest/serve/api/doc/ray.serve.request_router.LocalityMixin.apply_locality_routing
- /en/latest/serve/api/doc/ray.serve.request_router.LocalityMixin.rank_replicas_via_locality
- /en/latest/serve/api/doc/ray.serve.request_router.MultiplexMixin
- /en/latest/serve/api/doc/ray.serve.request_router.MultiplexMixin.apply_multiplex_routing
- /en/latest/serve/api/doc/ray.serve.request_router.MultiplexMixin.rank_replicas_via_multiplex
- /en/latest/serve/api/doc/ray.serve.request_router.RequestRouter
- /en/latest/serve/api/doc/ray.serve.request_router.RequestRouter.choose_replicas
- /en/latest/serve/api/doc/ray.serve.request_router.RequestRouter.on_request_routed
- /en/latest/serve/api/doc/ray.serve.request_router.RequestRouter.select_available_replicas
canonical_path: /en/latest/serve/advanced-guides/custom-request-router
source: https://github.com/ray-project/ray/blob/master/doc/source/serve/advanced-guides/custom-request-router.md
...
> **Note:** This request router also implements [`on_request_routed`](../api/doc/ray.serve.request_router.RequestRouter.on_request_routed.rst)
...
> **Note:** Currently, the only way to configure the request router is to pass it as an argument to
...
> **Note:** If you experience the following error when the `CapacityQueue` actor experiences faults and routing decisions fall back to the power-of-two-choices router,
