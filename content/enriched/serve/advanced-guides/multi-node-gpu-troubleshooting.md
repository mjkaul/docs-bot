---
id: serve.advanced-guides.multi-node-gpu-troubleshooting
title: Troubleshoot multi-node GPU serving on KubeRay
topic_type: task
description: ''
subjects:
- serve
...
- worker
references: []
canonical_path: /en/latest/serve/advanced-guides/multi-node-gpu-troubleshooting
source: https://github.com/ray-project/ray/blob/master/doc/source/serve/advanced-guides/multi-node-gpu-troubleshooting.md
