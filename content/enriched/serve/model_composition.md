---
id: serve.model_composition
title: Deploy Compositions of Models
topic_type: concept
description: ''
subjects:
- serve
...
- task
references: []
canonical_path: /en/latest/serve/model_composition
source: https://github.com/ray-project/ray/blob/master/doc/source/serve/model_composition.md
...
> **Note:** The deprecated `RayServeHandle` and `RayServeSyncHandle` APIs have been fully removed as of Ray 2.10.
...
> **Warning:** You can use the `response.result()` method to get the return value of remote `DeploymentHandle` calls.
...
> **Warning:** Passing a `DeploymentResponse` to downstream handle calls in nested objects is fully deprecated and no longer supported.
