...
- deployment
references: []
canonical_path: /en/latest/serve/model-registries
source: https://github.com/ray-project/ray/blob/master/doc/source/serve/model-registries.md
