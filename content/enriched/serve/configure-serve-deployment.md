---
id: serve.configure-serve-deployment
title: Configure Ray Serve deployments
topic_type: task
description: ''
subjects:
- serve
...
- serve-handle
references:
- /en/latest/serve/api/doc/ray.serve.Deployment
- /en/latest/serve/api/doc/ray.serve.deployment_decorator
- /en/latest/serve/api/doc/ray.serve.schema.LoggingConfig
canonical_path: /en/latest/serve/configure-serve-deployment
source: https://github.com/ray-project/ray/blob/master/doc/source/serve/configure-serve-deployment.md
