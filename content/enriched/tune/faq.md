...
- worker
references: []
canonical_path: /en/latest/tune/faq
source: https://github.com/ray-project/ray/blob/master/doc/source/tune/faq.rst
...
See the tune-autofilled-metrics section for a glossary.
...
First, follow the instructions in python-develop to develop Tune without compiling Ray.
...
You should configure shared storage. See this user guide: tune-storage-options.
...
> **Warning:** The `TUNE_ORIG_WORKING_DIR` environment variable was the original workaround for
...
tune-fault-tolerance-ref explains that the usage of Tuner.restore
