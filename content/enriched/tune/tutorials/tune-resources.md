---
id: tune.tutorials.tune-resources
title: A Guide To Parallelism and Resources for Ray Tune
topic_type: task
description: ''
subjects:
- tune
...
- worker
references: []
canonical_path: /en/latest/tune/tutorials/tune-resources
source: https://github.com/ray-project/ray/blob/master/doc/source/tune/tutorials/tune-resources.rst
...
> **Note:** The resources specified this way will only be allocated for scheduling Tune trials.
