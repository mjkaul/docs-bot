---
id: tune.tutorials.tune-metrics
title: A Guide To Callbacks & Metrics in Tune
topic_type: task
description: ''
subjects:
- tune
...
- worker
references: []
canonical_path: /en/latest/tune/tutorials/tune-metrics
source: https://github.com/ray-project/ray/blob/master/doc/source/tune/tutorials/tune-metrics.rst
...
> **Tip:** Note that `tune.report()` is not meant to transfer large amounts of data, like models or datasets.
