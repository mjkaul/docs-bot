---
id: data.data-internals
title: Ray Data Internals
topic_type: concept
description: ''
subjects:
- data
...
- worker
references: []
canonical_path: /en/latest/data/data-internals
source: https://github.com/ray-project/ray/blob/master/doc/source/data/data-internals.rst
...
Dataset is the main user-facing Python API. It represents a
...
attributes of ~ray.data.context.DataContext.
...
physical operators. When you call APIs like ray.data.read_images and
ray.data.Dataset.map_batches, Ray Data produces a logical plan. When execution
...
ray.data.DataContext.get_current().scheduling_strategy. This scheduling strategy schedules these Tasks and Actors outside any present
...
> **Note:** Zero-copy deserializable objects are an exception. They're used in the UDF but
...
> **Note:** A common misconception is that heavy queuing causes OOMs. While it's true that heavy 
