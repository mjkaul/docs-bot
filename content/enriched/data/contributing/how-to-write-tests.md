---
id: data.contributing.how-to-write-tests
...
- dataset
references: []
canonical_path: /en/latest/data/contributing/how-to-write-tests
source: https://github.com/ray-project/ray/blob/master/doc/source/data/contributing/how-to-write-tests.md
license: Apache 2.0, The Ray Authors
---

# How to write tests

> **Note:** **Disclaimer**: There are no hard rules in software engineering. Use your judgment when 
applying these.
...
> **Tip:** Use the `ray.data._internal.util.rows_same` utility function to compare pandas 
...
> **Note:** There's an inherent tradeoff between isolation and speed here. For this specific case, 
