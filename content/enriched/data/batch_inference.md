---
id: data.batch_inference
title: 'End-to-end: Offline Batch Inference'
topic_type: concept
description: ''
subjects:
- data
...
- task
references: []
canonical_path: /en/latest/data/batch_inference
source: https://github.com/ray-project/ray/blob/master/doc/source/data/batch_inference.rst
...
> **Note:** This guide is primarily focused on batch inference with deep learning frameworks.
...
~ray.data.DataContext. See the
Execution Configurations guide for details.
...
3. Specify a `batch_size` for inference. For more details on how to configure the batch size, see Configuring Batch Size.
