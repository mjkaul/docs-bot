...
- worker
references: []
canonical_path: /en/latest/data/joining-data
source: https://github.com/ray-project/ray/blob/master/doc/source/data/joining-data.rst
license: Apache 2.0, The Ray Authors
---

Joining Data

Ray Data allows multiple ~ray.data.dataset.Dataset instances to be joined using different join types based on the provided key columns as follows:
