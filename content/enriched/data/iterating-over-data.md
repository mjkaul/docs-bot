...
- worker
references: []
canonical_path: /en/latest/data/iterating-over-data
source: https://github.com/ray-project/ray/blob/master/doc/source/data/iterating-over-data.rst
...
> **Tip:** To configure `local_shuffle_buffer_size`, choose the smallest value that achieves
...
> **Note:** If you're using Ray Train, you don't need to split the dataset.
