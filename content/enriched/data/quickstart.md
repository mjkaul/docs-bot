...
- task
references: []
canonical_path: /en/latest/data/quickstart
source: https://github.com/ray-project/ray/blob/master/doc/source/data/quickstart.rst
...
Access dataset contents through convenient methods like ~ray.data.Dataset.take_batch and 
~ray.data.Dataset.iter_batches. You can also pass datasets directly to Ray Tasks or Actors
...
like ~ray.data.Dataset.write_parquet, ~ray.data.Dataset.write_csv, and more.
