---
id: data.how-to-avoid-ooms
title: How to avoid out-of-memory errors (OOMs)
topic_type: task
description: ''
subjects:
- data
...
- worker
references: []
canonical_path: /en/latest/data/how-to-avoid-ooms
source: https://github.com/ray-project/ray/blob/master/doc/source/data/how-to-avoid-ooms.md
...
- Ray Data Memory Model
- Ray Core Resource Isolation
- Ray Core Out-Of-Memory Prevention
