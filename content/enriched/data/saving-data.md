...
- head-node
references: []
canonical_path: /en/latest/data/saving-data
source: https://github.com/ray-project/ray/blob/master/doc/source/data/saving-data.rst
...
To save your ~ray.data.dataset.Dataset to local disk, call a method
like Dataset.write_parquet  and specify a local
directory with the `local://` scheme.

> **Warning:** If your cluster contains multiple nodes and you don't use `local://`, Ray Data
...
To save your ~ray.data.dataset.Dataset to cloud storage, authenticate all nodes
...
To save your ~ray.data.dataset.Dataset to NFS file systems, call a method
...
> **Note:** `min_rows_per_file` is a hint, not a strict limit. Ray Data might write more or
...
To convert a ~ray.data.dataset.Dataset to a pandas DataFrame, call
...
Mars.
        ...
        To convert a ~ray.data.dataset.Dataset to a [Daft Dataframe](https://docs.getdaft.io/en/stable/api/dataframe/), call
        Dataset.to_daft().
        ...
        To convert a ~ray.data.dataset.Dataset to a
...
:skipif: True
        ...
        To convert a ~ray.data.dataset.Dataset to a [Spark DataFrame](https://spark.apache.org/docs/latest/api/python/reference/pyspark.sql/dataframe.html),
...
:hide:
        ...
        To convert a ~ray.data.dataset.Dataset to a Modin DataFrame, call
        Dataset.to_modin().
        ...
        To convert a ~ray.data.dataset.Dataset from a Mars DataFrame, call
        Dataset.to_mars().
