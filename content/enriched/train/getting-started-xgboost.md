---
id: train.getting-started-xgboost
title: Get Started with Distributed Training using XGBoost
topic_type: task
description: ''
subjects:
- train
...
- worker
references: []
canonical_path: /en/latest/train/getting-started-xgboost
source: https://github.com/ray-project/ray/blob/master/doc/source/train/getting-started-xgboost.rst
...
3. Launch a distributed training job with a ~ray.train.xgboost.XGBoostTrainer.
...
3. ~ray.train.xgboost.XGBoostTrainer launches the distributed training job.
...
with a ~ray.train.xgboost.XGBoostTrainer.
