...
- worker
references: []
canonical_path: /en/latest/train/overview
source: https://github.com/ray-project/ray/blob/master/doc/source/train/overview.rst
...
The number of workers determines the parallelism of the training job and is configured in the ~ray.train.ScalingConfig.

Scaling configuration

The ~ray.train.ScalingConfig is the mechanism for defining the scale of the training job.
