---
id: train.distributed-tensorflow-keras
title: Get Started with Distributed Training using TensorFlow/Keras
topic_type: task
description: ''
subjects:
- train
...
- worker
references: []
canonical_path: /en/latest/train/distributed-tensorflow-keras
source: https://github.com/ray-project/ray/blob/master/doc/source/train/distributed-tensorflow-keras.rst
...
> **Note:** The current TensorFlow implementation supports
...
> **Warning:** Ray doesn't automatically set any environment variables or configuration
...
use a ~ray.train.tensorflow.TensorflowTrainer
...
the ~ray.train.Result, and access the best saved checkpoints with the `best_checkpoints`
attribute.
