---
id: train.user-guides.experiment-tracking
...
- worker
references: []
canonical_path: /en/latest/train/user-guides/experiment-tracking
source: https://github.com/ray-project/ray/blob/master/doc/source/train/user-guides/experiment-tracking.rst
...
logic inside the train_func function.
...
> **Tip:** A major difference between distributed and non-distributed training is that in distributed training,
...
The interaction with the experiment tracking backend within the train_func
has 4 logical steps:
...
If applicable, make sure that you properly set up credentials on each training worker.
        ...
        **Online**
        ...
        inside of train_func. See Set up credentials
...
:skipif: True
        ...
        **Offline**
        ...
        See Set up a shared file system for more information.
...
:skipif: True
        ...
        **Local**
        ...
        to. See Set up a shared file system for more information.
...
mlflow.start_run()
        ...
        **Remote, hosted by Databricks**
        ...
        See Set up credentials for more information.
...
runtime environments, where you initialize with the following code:
...
> **Tip:** When performing **fault-tolerant training** with auto-restoration, use a
