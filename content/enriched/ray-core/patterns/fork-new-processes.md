---
id: ray-core.patterns.fork-new-processes
title: 'Anti-pattern: Forking new processes in application code'
topic_type: concept
description: ''
subjects:
- core
...
- task
references: []
canonical_path: /en/latest/ray-core/patterns/fork-new-processes
source: https://github.com/ray-project/ray/blob/master/doc/source/ray-core/patterns/fork-new-processes.rst
