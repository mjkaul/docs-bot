---
id: ray-core.patterns.ray-get-loop
title: 'Anti-pattern: Calling ray.get in a loop harms parallelism'
topic_type: concept
description: ''
subjects:
- core
...
- task
references: []
canonical_path: /en/latest/ray-core/patterns/ray-get-loop
source: https://github.com/ray-project/ray/blob/master/doc/source/ray-core/patterns/ray-get-loop.rst
