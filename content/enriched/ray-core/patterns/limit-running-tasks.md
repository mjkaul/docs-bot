---
id: ray-core.patterns.limit-running-tasks
title: 'Pattern: Using resources to limit the number of concurrently running tasks'
topic_type: concept
description: ''
subjects:
- core
...
- task
references: []
canonical_path: /en/latest/ray-core/patterns/limit-running-tasks
source: https://github.com/ray-project/ray/blob/master/doc/source/ray-core/patterns/limit-running-tasks.rst
...
> **Note:** For actor tasks, the number of running actors limits the number of concurrently running actor tasks we can have.
