---
id: ray-core.objects.serialization
title: Serialization
topic_type: concept
description: ''
subjects:
...
- worker
references: []
canonical_path: /en/latest/ray-core/objects/serialization
source: https://github.com/ray-project/ray/blob/master/doc/source/ray-core/objects/serialization.rst
...
Whenever serialization fails, Ray throws an UnserializableException containing the string representation of the original stack trace.
