...
- worker
references: []
canonical_path: /en/latest/ray-core/miscellaneous
source: https://github.com/ray-project/ray/blob/master/doc/source/ray-core/miscellaneous.rst
...
The above information includes:
  ...
  - `MetricsExportPort`: The port number at which metrics are exposed to through a [Prometheus endpoint](ray-metrics.html).
