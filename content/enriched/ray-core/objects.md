...
- task
references: []
canonical_path: /en/latest/ray-core/objects
source: https://github.com/ray-project/ray/blob/master/doc/source/ray-core/objects.rst
...
> **Note:** Remote objects are immutable. That is, their values cannot be changed after
