---
id: ray-core.ray-generator
title: Ray Generators
topic_type: concept
description: ''
subjects:
- core
...
- worker
references: []
canonical_path: /en/latest/ray-core/ray-generator
source: https://github.com/ray-project/ray/blob/master/doc/source/ray-core/ray-generator.rst
...
> **Note:** For a normal Python generator, a generator function is paused and resumed when `next` function is
