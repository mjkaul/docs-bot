---
id: ray-core.using-ray-with-jupyter
title: Working with Jupyter Notebooks & JupyterLab
topic_type: concept
description: ''
subjects:
- core
...
- object-store
references: []
canonical_path: /en/latest/ray-core/using-ray-with-jupyter
source: https://github.com/ray-project/ray/blob/master/doc/source/ray-core/using-ray-with-jupyter.rst
...
> **Tip:** While the above settings help reduce memory footprint, it's always a good
