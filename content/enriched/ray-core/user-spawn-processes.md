---
id: ray-core.user-spawn-processes
title: Lifetimes of a User-Spawn Process
topic_type: concept
description: ''
subjects:
- core
...
- worker
references: []
canonical_path: /en/latest/ray-core/user-spawn-processes
source: https://github.com/ray-project/ray/blob/master/doc/source/ray-core/user-spawn-processes.rst
