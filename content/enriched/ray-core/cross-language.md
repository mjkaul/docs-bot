---
id: ray-core.cross-language
title: Cross-language programming
topic_type: concept
description: ''
subjects:
- core
...
- worker
references: []
canonical_path: /en/latest/ray-core/cross-language
source: https://github.com/ray-project/ray/blob/master/doc/source/ray-core/cross-language.rst
...
You need to set code_search_path in your driver.
...
> **Note:** * You should decorate the function or class with `@ray.remote`.
...
> **Note:** * Be aware of float / double precision between Python and Java. If Java is using a
