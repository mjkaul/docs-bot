---
id: ray-core.runtime_env_auth
title: Authenticating Remote URIs in runtime_env
topic_type: concept
description: ''
subjects:
- core
...
- runtime-env
references: []
canonical_path: /en/latest/ray-core/runtime_env_auth
source: https://github.com/ray-project/ray/blob/master/doc/source/ray-core/runtime_env_auth.md
...
> **Note:** On Unix, name the `netrc` file as `.netrc`. On Windows, name the
file as `_netrc`.
