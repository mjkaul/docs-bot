---
id: ray-core.actors.concurrency_group_api
title: Limiting Concurrency Per-Method with Concurrency Groups
topic_type: concept
description: ''
subjects:
- core
...
- task
references: []
canonical_path: /en/latest/ray-core/actors/concurrency_group_api
source: https://github.com/ray-project/ray/blob/master/doc/source/ray-core/actors/concurrency_group_api.rst
