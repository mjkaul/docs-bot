---
id: ray-core.actors.named-actors
title: Named Actors
topic_type: concept
description: ''
subjects:
...
- task
references: []
canonical_path: /en/latest/ray-core/actors/named-actors
source: https://github.com/ray-project/ray/blob/master/doc/source/ray-core/actors/named-actors.rst
...
> **Note:** Named actors are scoped by namespace. If no namespace is assigned, they will
