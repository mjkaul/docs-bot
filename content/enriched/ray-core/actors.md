...
- worker
references: []
canonical_path: /en/latest/ray-core/actors
source: https://github.com/ray-project/ray/blob/master/doc/source/ray-core/actors.rst
...
Specify resource requirements in actors. See resource-requirements for more details.
...
For more details and advanced patterns, see Type hints in Ray.
...
For Tasks classified as async Actors, Ray seeks to cancel the associated `asyncio.Task`.
