---
id: ray-core.fault_tolerance.actors
title: Actor Fault Tolerance
topic_type: concept
description: ''
subjects:
- core
...
- worker
references: []
canonical_path: /en/latest/ray-core/fault_tolerance/actors
source: https://github.com/ray-project/ray/blob/master/doc/source/ray-core/fault_tolerance/actors.rst
...
> **Note:** For async or threaded actors, tasks might be
...
> **Note:** If the checkpoint is saved to external storage, make sure
