...
- namespace
references: []
canonical_path: /en/latest/ray-core/namespaces
source: https://github.com/ray-project/ray/blob/master/doc/source/ray-core/namespaces.rst
...
Please refer to [Driver Options](configure.html#driver-options) for ways of configuring a Java application.
...
> **Note:** Anonymous namespaces are implemented as UUID's. This makes it possible for
