...
- worker
references: []
canonical_path: /en/latest/ray-core/scheduling/labels
source: https://github.com/ray-project/ray/blob/master/doc/source/ray-core/scheduling/labels.md
...
| `ray.io/accelerator-type` | The accelerator type of the node, for example `L4`. CPU-only machines don't have the label. See accelerator types for a mapping of values. |
