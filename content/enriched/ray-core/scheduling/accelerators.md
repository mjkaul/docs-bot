---
id: ray-core.scheduling.accelerators
...
- worker
references: []
canonical_path: /en/latest/ray-core/scheduling/accelerators
source: https://github.com/ray-project/ray/blob/master/doc/source/ray-core/scheduling/accelerators.rst
...
> **Tip:** You can set the `CUDA_VISIBLE_DEVICES` environment variable before starting a Ray node
...
> **Tip:** You can set the `ROCR_VISIBLE_DEVICES` environment variable before starting a Ray node
...
> **Tip:** You can set the `ONEAPI_DEVICE_SELECTOR` environment variable before starting a Ray node
...
> **Tip:** You can set the `NEURON_RT_VISIBLE_CORES` environment variable before starting a Ray node
...
> **Tip:** You can set the `TPU_VISIBLE_CHIPS` environment variable before starting a Ray node
...
> **Tip:** You can set the `HABANA_VISIBLE_MODULES` environment variable before starting a Ray node
...
> **Tip:** You can set the `ASCEND_RT_VISIBLE_DEVICES` environment variable before starting a Ray node
...
> **Tip:** You can set the `RBLN_DEVICES` environment variable before starting a Ray node
...
> **Tip:** You can set the `FURIOSA_DEVICES` environment variable before starting a Ray node
...
> **Note:** When using the `furiosa_llm.LLM` Python API inside a Ray task or actor,
...
> **Note:** There's nothing preventing you from specifying a larger number of
