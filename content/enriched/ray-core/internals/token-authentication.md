---
id: ray-core.internals.token-authentication
...
mentions: []
references: []
canonical_path: /en/latest/ray-core/internals/token-authentication
source: https://github.com/ray-project/ray/blob/master/doc/source/ray-core/internals/token-authentication.rst
...
> **Note:** Whitespace is stripped when reading the token from files to avoid issues from trailing newlines.
...
> **Note:** For HTTP, middleware and header injection are not automatically wired up for new services;
...
> **Note:** HTTP middleware and header injection are not automatically wired up - they must be added
