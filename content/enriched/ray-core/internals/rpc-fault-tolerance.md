---
id: ray-core.internals.rpc-fault-tolerance
title: RPC Fault Tolerance
topic_type: concept
description: ''
subjects:
- core
...
- worker
references: []
canonical_path: /en/latest/ray-core/internals/rpc-fault-tolerance
source: https://github.com/ray-project/ray/blob/master/doc/source/ray-core/internals/rpc-fault-tolerance.rst
...
> **Note:** Initially, Amazon FIS was considered. However, it has a 60-second minimum which caused node 
